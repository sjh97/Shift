package com.JH571121692Developer.shift.cosmocalendar.view;
...
import com.JH571121692Developer.shift.cosmocalendar.FetchMonthsAsyncTask;
import com.JH571121692Developer.shift.cosmocalendar.adapter.MonthAdapter;
import com.JH571121692Developer.shift.cosmocalendar.listeners.OnMonthChangeListener;
...
import com.JH571121692Developer.shift.cosmocalendar.selection.NoneSelectionManager;
import com.JH571121692Developer.shift.cosmocalendar.selection.OnDaySelectedListener;
import com.JH571121692Developer.shift.cosmocalendar.selection.RangeSelectionManager;
import com.JH571121692Developer.shift.cosmocalendar.selection.SingleSelectionManager;
import com.JH571121692Developer.shift.cosmocalendar.selection.selectionbar.MultipleSelectionBarAdapter;
...
import com.JH571121692Developer.shift.cosmocalendar.utils.WeekDay;
import com.JH571121692Developer.shift.cosmocalendar.view.customviews.CircleAnimationTextView;
import com.JH571121692Developer.shift.cosmocalendar.view.customviews.SquareTextView;
import com.JH571121692Developer.shift.cosmocalendar.view.delegate.MonthDelegate;
...
//        rvMonths.setOrientation(settingsManager.getCalendarOrientation());
        ...
        rvMonths.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                int totalItemCount = monthAdapter.getData().size();
                ...
                if (position < (int) (totalItemCount * 0.1) + 1) {
                    loadAsyncMonths(false);
                }
                else if (position >= (int) (totalItemCount * 0.9)) {
