...
public final class CalendarUtils {
    ...
    public static String getYearNameTitle(Day day) {
        return new SimpleDateFormat("yyyy MMM").format(day.getCalendar().getTime());
    }
    ...
    public static void setDay(Day day, SettingsManager settingsManager) {
        ...
        if (settingsManager.getDayContents() != null){
            for(DayContent dayContent : settingsManager.getDayContents()){
                if(day.getCalendar().getTime() == dayContent.getContentDate()){
